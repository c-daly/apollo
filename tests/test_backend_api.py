...
class TestMediaEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_upload_media_success(self, test_client, monkeypatch, sample_media_file):
    ...
    @pytest.mark.skip(reason="File size validation requires actual large file or complex mocking of UploadFile internals")
    @pytest.mark.asyncio  
    async def test_upload_media_file_too_large(self, test_client, monkeypatch):
        ...
        async def mock_upload_large(file: UploadFile, media_type: str, question: str = None):
